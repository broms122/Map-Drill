...
namespace MapDrill
{
    public class Gizmo_SetFuelLevel_MapDrill : Gizmo_Slider
    {
        private CompRefuelable_MapDrill refuelable;
        ...
        public Gizmo_SetFuelLevel_MapDrill(CompRefuelable_MapDrill refuelable)
        {
        ...
        protected override void DrawHeader(Rect headerRect, ref bool mouseOverElement)
        {
            if (refuelable.Props.showAllowAutoRefuelToggle)
            {
                ...
                GUI.DrawTexture(new Rect(rect.center.x, rect.y, rect.width / 2f, rect.height / 2f), (Texture)(refuelable.allowAutoRefuel ? Widgets.CheckboxOnTex : Widgets.CheckboxOffTex));
