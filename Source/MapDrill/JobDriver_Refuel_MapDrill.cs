...
namespace MapDrill
{
    ...
    public class JobDriver_Refuel_MapDrill : JobDriver
    {
        ...
        protected CompRefuelable_MapDrill RefuelableComp => Refuelable.TryGetComp<CompRefuelable_MapDrill>();
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            yield return Toils_Refuel_MapDrill.FinalizeRefueling(TargetIndex.A, TargetIndex.B);
        }
    }
