...
namespace MapDrill
{
    public class WorkGiver_MapDrill : WorkGiver_Scanner
    {
        ...
        public override bool ShouldSkip(Pawn pawn, bool forced = false)
        {
            ...
            for (int i = 0; i < allBuildingsColonist.Count; i++)
            {
                ...
                if (building.def == ThingDefOf.MapDrill)
                {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            if (!building.TryGetComp<CompDrill_MapDrill>().CanDrillNow())
            {
                return false;
            }
        ...
        {
            return JobMaker.MakeJob(JobDefOf.OperateMapDrill, t, 1500, checkOverrideOnExpiry: true);
        }
    }
