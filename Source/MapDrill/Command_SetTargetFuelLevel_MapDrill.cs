...
namespace MapDrill
{
    ...
    public class Command_SetTargetFuelLevel_MapDrill : Command
    {
        public CompRefuelable_MapDrill refuelable;

        private List<CompRefuelable_MapDrill> refuelables;
        ...
        public override void ProcessInput(Event ev)
        {
            ...
            if (refuelables == null)
            {
                refuelables = new List<CompRefuelable_MapDrill>();
            }
        ...
        public override bool InheritInteractionsFrom(Gizmo other)
        {
            ...
            refuelables.Add(((Command_SetTargetFuelLevel_MapDrill)other).refuelable);
            return false;
        }
    }
}
